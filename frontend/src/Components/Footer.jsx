...
function Footer({ setCurrentPage }) {
  ...
  return (
    <footer className="bg-primary-600 text-light mt-auto border-t border-white/10">
      <div className="max-w-7xl mx-auto px-5 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="#facebook" className="flex items-center justify-center w-9 h-9 bg-white/15 text-white rounded-lg hover:bg-secondary transition-colors" title="Facebook">
              ...
              <a href="#linkedin" className="flex items-center justify-center w-9 h-9 bg-white/15 text-white rounded-lg hover:bg-secondary transition-colors" title="LinkedIn">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="currentColor">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#faq" className="text-gray-300 text-sm hover:text-white transition-colors duration-200">FAQ</a></li>
              <li><button onClick={handleContactClick} className="text-gray-300 text-sm hover:text-white transition-colors duration-200">Contact Us</button></li>
              <li><a href="#docs" className="text-gray-300 text-sm hover:text-white transition-colors duration-200">Documentation</a></li>
              <li><a href="#feedback" className="text-gray-300 text-sm hover:text-white transition-colors duration-200">Feedback</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#cookies" className="text-gray-300 text-sm hover:text-white transition-colors duration-200">Cookies</a></li>
              <li><a href="#compliance" className="text-gray-300 text-sm hover:text-white transition-colors duration-200">Compliance</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-8 text-center">
          ...
          <p className="text-xs italic text-secondary font-medium mt-2">Empowering Education Through Better Event Management</p>
        </div>
      </div>
    </footer>
  );
