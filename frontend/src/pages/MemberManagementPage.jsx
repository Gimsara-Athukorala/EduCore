...
const MemberManagementPage = () => {
  ...
  const initialFilter = searchParams.get('tab') === 'requests' ? 'Pending Requests' : 'All';
    ...
    <SocietyLeaderDashboardShell>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 animate-fadeUp">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          ...
          <Button variant="secondary" onClick={() => navigate('/societies/create')}>
            <ChevronLeft className="w-4 h-4 mr-2" />
            Back to Create Society
          </Button>
        </div>
